...
class  StructerEditModal extends React.Component {
        constructor(props) {
            super(props);
            this.state = {
                structer : {
                        ...
                        <div className="px-4 py-4 text-lg tracking-wider leading-loose">
                            ...
                            <form ref={(el) => this.myFormRef = el} onSubmit={this.handleSubmit}>
                                ...
                                <div className="grid-cols-3 grid gap-4 mb-4">
                                    ...
                                    <span className="block w-64">
                                    <strong>{this.state.structer.DelegStruct}</strong>
                                    </span>
                                    <span className="block w-64">
                                    <strong>{this.state.structer.SectorStruct}</strong>
                                    </span>
                                </div>
                                <div className="grid-cols-3 grid gap-4">
                                    ...
                                    <div className="mb-4 w-64">
                                        <label htmlFor="DateCrea" className="block mb-1">
                                            Date Creation : {moment(this.state.structer.DateCrea).format('MMMM Do YYYY')}
                                            <span className="text-red-500">*</span>
                                        </label>
                                        <input
                                        type="date"
...
export default connect(mapStateToProps, mapDispatchToProps)(StructerEditModal);