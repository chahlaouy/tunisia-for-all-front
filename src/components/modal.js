...
class  Modal extends React.Component {
    ...
    this.setState({ member: memberDetails });
      ...
      handleSubmit(event) {
        ...
        axios.post("http://localhost:3001/api/members/upload", data, {})
          .then(res => { 
        ...
        return (
            <div className="h-screen overflow-scroll py-8">
                ...
                <div className="relative z-40 bg-white shadow-2xl rounded-lg -mt-2">
                        <h2 className="text-4xl bg-green-300 text-gray-800 px-4 py-4 rounded-t-lg uppercase"> Ajouter un adhérant</h2>
